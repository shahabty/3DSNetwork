...
import trimesh
from deps import libmcubes
from utils import make_3d_grid
from deps.libsimplify import simplify_mesh
from deps.libmise import MISE
import time
...
def get_generator(model):
    ...
    '''
    #preprocessor = get_preprocessor(cfg, device='cuda:0')
...
class Generator3D(object):
    ...
    '''
    #resolution0 used to be 16 in the method
    def __init__(self, model, points_batch_size=100000,
                 threshold=0.5, refinement_step=0, device=None,
                 resolution0=64, upsampling_steps=3,
    ...
    def eval_points(self, p, c=None, **kwargs):
        ...
        for pi in p_split:
            ...
            with torch.no_grad():
                occ_hat = self.model.decoder(pi, c)
    ...
    def estimate_normals(self, vertices, z, c=None):
        ...
        for vi in vertices_split:
            ...
            vi.requires_grad_()
            occ_hat = self.model.decoder(vi, c)
            out = occ_hat.sum()
            out.backward()
            ni = -vi.grad
    ...
    def refine_mesh(self, mesh, occ_hat, z, c=None):
        ...
        for it_r in trange(self.refinement_step):
            ...
            face_value = torch.sigmoid(
                self.model.decoder(face_point.unsqueeze(0), c)
            )
